            ...
            while ((linea = br.readLine()) != null) {
                ...
                if (datos.length == 17) {
                    try {
                        ...
                        Curso curso = new Curso(cursoId, cursoNombre, programaCurso, cursoActivo);
                        ...
                        Estudiante estudiante = new Estudiante(estudianteId, nombres, apellidos, email, codigo, programaEstudiante, activo, promedio);
